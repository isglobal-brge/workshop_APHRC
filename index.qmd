...
Welcome to the workshop where privacy-preserving analytics meets standardized clinical data! This hands-on session will introduce you to the combination of DataSHIELD's federated analysis capabilities and the OMOP Common Data Model (CDM) for clinical databases using the dsOMOP framework.
